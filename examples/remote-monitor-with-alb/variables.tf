...
variable "rm_version" {
  description = "(Optional) The version of Remote Monitor to be installed"
  type        = string
  default     = null
}
...
variable "zone_id" {
  description = "The ID of the Route53 hosted zone where the CNAME records of Remote Monitor instances are stored"
  type        = string
}

variable "web_admin_email" {
  description = "The admin email address to log in to Remote Monitor"
  type        = string
  sensitive   = true
}

variable "web_admin_password" {
  description = "The admin password to log in to Remote Monitor"
  type        = string
  sensitive   = true
}
