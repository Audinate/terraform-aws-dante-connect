...
| <a name="input_create_alb"></a> [create\_alb](#input\_create\_alb) | (Optional) True if an ALB in front of the Remote Monitor must be created (to perform HTTPS termination) | `bool` | `false` | no |
...
| <a name="input_installer_version"></a> [installer\_version](#input\_installer\_version) | (Optional) The version of the Remote Monitor to be installed | `string` | `"1.0.0.4"` | no |
| <a name="input_instance_type"></a> [instance\_type](#input\_instance\_type) | (Optional) Instance type to use for the Remote Monitor instance. Updates to this field will trigger a stop/start of the instance | `string` | `"m5.large"` | no |
...
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | The VPC ID the Remote Monitor instance will be created in | `string` | n/a | yes |
| <a name="input_vpc_security_group_ids"></a> [vpc\_security\_group\_ids](#input\_vpc\_security\_group\_ids) | (Optional) List of security group IDs the Remote Monitor instance will be associated with | `list(string)` | `null` | no |
