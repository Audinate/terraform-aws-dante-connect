...
| <a name="input_resource_url"></a> [resource\_url](#input\_resource\_url) | The url to download a remote-contributor installer | `string` | `"https://audinate-dante-connect.sgp1.cdn.digitaloceanspaces.com/remote-contributor"` | no |
